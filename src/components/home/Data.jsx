...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Subhajit Srimani
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            A Frontend Web Developer, Competitive Coding and Machine Learning enthusiast with excellent communication skills, excited to give my best in achieving remarkable outcomes.
            </p>
