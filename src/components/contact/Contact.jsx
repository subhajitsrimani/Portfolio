        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <a
                href="mailto:subhajit.01srimani@gmail.com"
            ...
            <div className="contact__card">
              ...
              <a
                href="https://api.whatsapp.com/send?phone=919674055041&text=Hello, more information!"
                className="contact__button" target="_blank"
              >
                Write me{" "}
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
            ...
            <div className="contact__card">
              ...
              <a href="https://t.me/srimanisubhajit" className="contact__button" target="_blank">
                Write me
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
            </div>
